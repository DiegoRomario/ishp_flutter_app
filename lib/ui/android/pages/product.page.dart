...
import 'package:ishp_flutter_app/models/product-details.model.dart';
import 'package:ishp_flutter_app/repositories/product.repository.dart';
import 'package:ishp_flutter_app/ui/shared/widgets/shared/progress-indicator.widget.dart';
      ...
      builder: (context, snapshot) {
        ...
        switch (snapshot.connectionState) {
          case ConnectionState.none:
            return Text("Conectando ao servidor...");
          ...
          case ConnectionState.done:
            if (snapshot.hasError)
              return Center(
                child: Text("Ocorreu um erro no aplicativo.;"),
              );
